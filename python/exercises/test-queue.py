...
parser.add_option("-a", "--alt",   choices=implementations,
                  help="Test alternative implementation PriorityQueue_<ALT>")
...
# ----------------------------------------------------------------------
if options.alt:
    name = "PriorityQueue_" + options.alt
    pqueue.PriorityQueue = getattr(pqueue, name)
# ----------------------------------------------------------------------
...
print("\nImplementation used:", pqueue.PriorityQueue.__name__)
